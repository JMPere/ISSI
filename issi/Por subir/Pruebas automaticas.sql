...
create or replace PACKAGE BODY PRUEBAS_CARRITO AS
  ...
  /*  PROCEDURE INSERTAR (NOMBRE_PRUEBA VARCHAR2, 
    ...
    BEGIN
        INSERT INTO CARRITO (NOMBREMUEBLE, NICKNAME_CLIENTE, PRECIO, CANTIDAD) 
            VALUES (W_NOMBREMUEBLE, W_NICKNAME_CLIENTE, W_PRECIO, W_CANTIDAD);

        SELECT * INTO TIPO_CARRITO FROM CARRITO WHERE NOMBREMUEBLE = W_NOMBREMUEBLE;
        IF (CARRITO.nombremueble.CUR <> W_NOMBREMUEBLE) THEN
            SALIDA := FALSE;
        END IF;
        COMMIT WORK;
