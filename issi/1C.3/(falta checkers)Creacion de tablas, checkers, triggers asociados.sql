...
DROP FUNCTION ACT_PRECIO_X_CANT;
...
-------------------------------------------------------------------------------------------------------SECUENCIAS   UPDATE MUEBLE SET STOCK WHERE 
...
CREATE OR REPLACE TRIGGER CANT_PRECIO_MUEBLES
...
CREATE OR REPLACE TRIGGER INSERTAR_PRECIO_BI
BEFORE INSERT ON CARRITO
FOR EACH ROW
...
CREATE OR REPLACE TRIGGER ACT_STOCK_MUEBLE_AI
...
-------------------------------------------------------------------------------------------------------INSERTS VENTAS
EXECUTE INSERTAR_VENTA('MANU131',2); -- CHECK PARA NUMPLAZOS Y CHECK STOCK
EXECUTE INSERTAR_VENTA('ALEX21',4);